...
\revised{The negative binomial distribution is well-suited to this application, for several reasons.  
It is supported over all non-negative integers, to accurately model both small and large cell counts.
Estimation of the dispersions also allows modelling of extra-Poisson variability in the counts between replicates.
