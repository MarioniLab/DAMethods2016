...
We also increased $r_0\sqrt{2}$ to 0.55 to ensure that most hyperspheres contained at least 15-20 cells, based on a plot similar to Figure~\ref{fig:nvd}.
...
\begin{figure}[p]
    ...
    \end{center}
    \caption{\revised{
            Differentially abundant subpopulations in the BMMC data set upon treatment with IL-10, detected at a spatial FDR of 5\% and visualized with a $t$-SNE plot.
