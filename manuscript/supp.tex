...
\revised{(That is, the most dispersed distribution of intensities will have a standard deviation no greater than $(2\sqrt{2})^{-1}$.)}
...
Before normalization, we observed strong shifts in the intensity of some markers between corresponding samples from different individuals (Supplementary Figure~\ref{fig:quantile}).
Part or all of this shift is likely caused by the technical effects of seperate staining and cytometry between individuals.
These shifts were successfully eliminated upon normalization, along with changes in the shape of the intensity distribution.
(It is worth noting, however, that this experimental design is not ideal for our quantile normalization procedure.
...
\begin{figure}[tbp]
    \begin{center}
        \includegraphics[width=0.49\textwidth,page=2,trim=0mm 0mm 0mm 20mm,clip]{../refdata/pics/ecdf_raw.pdf}
        \includegraphics[width=0.49\textwidth,page=2,trim=0mm 0mm 0mm 20mm,clip]{../refdata/pics/ecdf_norm.pdf}
    \end{center}
    \caption{\revised{Empirical cumulative distribution functions for CD19 intensities of BMMCs from five healthy untreated patients in the Levine \textit{et al.} data set, before (left) and after (right) quantile normalization.
        Each curve represents a separate patient and is labelled with a different colour.
    }
    }
    \label{fig:quantile}
\end{figure}
