...
\begin{color}{red}
\section{Detecting shifts in marker intensity}
...
\subsection{Direct detection of intensity shifts}
...
We observed that both methods were able to consistently detect shifts in intensity affecting the entire population of cells (Supplementary Figure~X).
Even small shifts were detected by the DA approach -- while the original population in one group and shifted population in the other group still overlap substantially in $M$-dimensional space, the differences in cell density are sufficient to detect the shifting event.
A more interesting scenario is that of large shifts in a subset of cells, where the robustness of the median becomes a disadvantage.
Specifically, the median is not suited to capturing changes in a subset of cells, reducing the power of the direct approach.
