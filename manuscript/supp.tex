...
The DA analysis revealed two major subpopulations with changes in abundance at a spatial FDR of 5\% -- namely, a CD11b\hi{} CD64\hi{} population of monocytes and a CD3\hi{} population of T cells (Supplementary Figure~\ref{fig:bmmc}).
Within each subpopulation, pSTAT3\hi{} hyperspheres increased in abundance upon IL-10 stimulation compared to the untreated samples, consistent with the expected effects of IL-10 simulation.
Similar to Levine \textit{et al.}, we found that only mature cellular populations and not progenitor bone marrow populations responded to IL-10 stimulation.
...
These CD7$^{\text{--}}$ T cells are known as a subset of memory cells in the periphery, but the presence of mature memory T cells in the bone marrow is also well-established (Zhao, 2011, Cell Mol Immunol; Okhrimenko, 2014, Proc Natl Acad Sci U S A).
Thus, our method is able to provide statistical rigour as well as additional biological insight, complementing Levine \textit{et al.}'s original findings.
...
\begin{figure}[p]
    \begin{center}
        \includegraphics[width=\textwidth]{pics/Figure_BMMC.pdf}
    \end{center}
    \caption{\revised{
