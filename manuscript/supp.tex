...
A hypersphere is considered non-redundant if its location is more than 1 intensity unit away (in one or more dimensions) from another non-redundant hypersphere with a lower $p$-value.
