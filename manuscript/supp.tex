...
Unlike quantile normalization, this range-based normalization approach does not assume that all differences between batches are technical.
Biological differences between batches are allowed, provided that they do not alter the ranges of the pooled distribution of intensities.
