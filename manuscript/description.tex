...
\revised{To illustrate, consider the total volume occupied by the set of DA hyperspheres.
    ...
    For example, the FDR across hyperspheres in Figure~\ref{fig:fdrexample} is 10\% while the spatial FDR across volume is over 30\%.
    These differences in spatial density of hypersheres is the main problem with overlapping hyperspheres, as alluded to earlier.}
