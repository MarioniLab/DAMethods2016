...
For example, relatively small and gradated differences are present between T cell subsets that are defined along a continuum of expression intensities for memory and activation markers such as CCR7 and CD38 \cite{???}.
