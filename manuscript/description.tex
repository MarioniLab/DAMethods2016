...
We ignore hypersphere-specific biases (e.g., due to \revised{misassignment of cells that have not been optimally stained}) as these are expected to cancel out when comparing counts from the same hypersphere.
