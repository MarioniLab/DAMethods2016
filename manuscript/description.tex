...
The Mann-Whitney test routinely yields larger $p$-values than edgeR for the same hyperspheres (Figure~\ref{fig:testtest}B), due to the loss of power from using ranks with small sample sizes in the former.
