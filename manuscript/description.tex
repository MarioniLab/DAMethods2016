...
Note that each cluster centre was only mapped if the distance to the closest hypersphere was less than $0.5\sqrt{M}$.
Any unmapped DA cluster was considered to be undetected by the hypersphere-based approach.
