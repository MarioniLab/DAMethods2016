...
% Subpopulations with more efficient antibodies are picked out more easily, so their hyperspheres will get more distinct counts.
% However, if the subpopulations have crappy antibodies, they won't separate out so well, so their hyperspheres will have fewer counts.
