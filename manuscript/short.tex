...
\revised{In this study, MEFs expressing various reporters (\textit{Oct4}-GFP, \textit{Nanog}-GFP or \textit{Nanog}-Neo) were reprogrammed to induced pluripotent stem cells.}
