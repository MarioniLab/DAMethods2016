...
Indeed, edgeR is more powerful than the commonly used Mann-Whitney test for detecting differences in hypersphere counts in simulated data, while still controlling the type I error rate (Supplementary Figure~\suppfigedgeR).
...
In this study, primary MEFs expressing green fluorescent protein (GFP) from the endogenous Oct4 locus (Oct4-GFP)
or secondary MEFs expressing either GFP or a neomycin resistance gene from the endogenous Nanog locus (Nanog-GFP or Nanog-Neo, respectively)
...
Here, we focus on the Oct4-GFP time course for brevity (see Supplementary Figures~\suppfigrealextra{} for all results).
...
This work was supported by Cancer Research UK (core funding, award no. A17197), the University of Cambridge and Hutchison Whampoa Limited.
