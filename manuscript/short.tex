...
\begin{figure}[btp]
    ...
    Two groups of hyperspheres are shown -- one containing true positives with genuine differences in abundance, the other containing false positives -- that occupy a similar total volume $V$ with different densities.
    }
    \label{fig:overview}
\end{figure}
...
(See Supplementary Note~\suppsecedgeR{} and Supplementary Figure~\suppfigfilter{} for \revised{more details}.)
